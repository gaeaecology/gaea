...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService) {
		...
		var wallet_defined_by_keys = require('GAEAcore/wallet_defined_by_keys.js');
		var objectHash = require('GAEAcore/object_hash.js');
		try{
			var ecdsa = require('secp256k1');
		}
		catch(e){
			var ecdsa = require('GAEAcore/node_modules/secp256k1' + '');
		}
		var Mnemonic = require('bitcore-mnemonic');
		var Bitcore = require('bitcore-lib');
		var db = require('GAEAcore/db.js');
		var network = require('GAEAcore/network');
		var myWitnesses = require('GAEAcore/my_witnesses');
		...
		function cleanAndAddWalletsAndAddresses(assocMaxAddressIndexes) {
			var device = require('GAEAcore/device');
